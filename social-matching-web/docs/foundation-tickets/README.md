...
- `src/components/ui/*` — base UI primitives (`Card`, `Button`, `RouterLinkButton`, …).
...
| [F-2: `/questionnaire` guard semantics](2026-04-20-02-questionnaire-guard-semantics.md) | done | Routing / spec alignment |
...
| [F-6: StatusBadge narrow tone model](2026-04-20-06-statusbadge-tone-model.md) | done | All lifecycle surfaces |
