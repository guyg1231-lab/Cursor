...
const DEMO_EVENTS: DemoEvent[] = [
  {
    title: 'פיקניק בפארק',
    vibe: 'פיקניק שקיעה על הדשא עם היכרות ושיחה טובה.',
    when: 'שישי, 16:30',
    where: 'פארק הירקון',
  ...
  },
  {
    ...
    vibe: 'משחק כדורעף חופים והיכרות תוך כדי סבבים.',
    when: 'שבת, 09:00',
    where: 'חוף גורדון',
  ...
  },
  {
    ...
    vibe: 'הליכת ערב על הים עם עצירה לקפה ושיחה.',
    when: 'שלישי, 18:45',
    where: 'טיילת תל אביב',
  ...
  {
    title: 'קפה בכיכר',
    vibe: 'קפה קצר בכיכר להיכרות נעימה בלי לחץ.',
    when: 'רביעי, 17:30',
    where: 'כיכר ביאליק',
  ...
  },
  {
    ...
    vibe: 'ערב חברתי פתוח עם מעגלי היכרות מתחלפים.',
    when: 'חמישי, 20:00',
    where: 'בית הצעירים',
  ...
  },
  {
    ...
    vibe: 'סרט משותף ושיחה פתוחה אחרי ההקרנה.',
    when: 'שני, 19:30',
