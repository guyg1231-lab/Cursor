...
const copy = {
  he: {
    introEyebrow: 'שלב ראשון: בסיס הפרופיל',
    introTitle: 'כמה שאלות שיעזרו לנו להכיר את הסגנון שלך',
    introBody:
      'זהו פרופיל בסיסי, לא בקשה לאירוע. המטרה היא להבין את הסגנון שלך, ההעדפות שלך, ומה מרגיש לך נוח.',
    identityTitle: 'פרטים בסיסיים',
    identityBody: 'הפרטים האלו עוזרים לנו לזהות אותך, ליצור קשר, ולשמור את הפרופיל עדכני.',
    fitTitle: 'סגנון והעדפות',
    fitBody: 'כאן אנחנו לומדים איך נוח לך להכיר אנשים חדשים ואיזה סגנון מרגיש לך טבעי.',
    comfortTitle: 'עוד קצת הקשר',
    comfortBody: 'עוד כמה שורות עוזרות לנו להפוך את הפרופיל ליותר מלא, אנושי, וברור.',
    whyWeAskSocial: 'הקישור הזה לא מוצג לציבור. הצוות משתמש בו רק לאימות זהות.',
    whyWeAskOrigin: 'קצת רקע על מאיפה את/ה עוזר לנו להבין טוב יותר את ההקשר שלך.',
    whyWeAskAboutYou: '2–5 שורות מספיקות. רק תעזרו לנו להבין אותך קצת יותר טוב.',
    section: 'חלק',
    back: 'חזרה',
    next: 'המשך',
    ...
    labels: {
      ...
      language_pref: 'איזו שפה הכי נוחה לך?',
      q22_interests: 'מה מעניין אותך?',
      q13_social_style: 'בסיטואציות חברתיות חדשות, מה הכי מתאים לך?',
      q17_recharge: 'אחרי תקופה עמוסה, איך הכי נוח לך להיטען?',
      q20_meeting_priority: 'מה הכי חשוב לך כשאת/ה פוגש/ת אנשים חדשים?',
      q_match_preference: 'איזה שילוב מרגיש לך הכי נכון?',
      q25_motivation: 'מה את/ה מחפש/ת באופן כללי מבחינה חברתית?',
      q26_about_you: 'ספר/י לנו בקצרה על עצמך',
      q27_comfort_needs: 'יש משהו שעוזר לך להרגיש בנוח?',
    },
  },
  en: {
    introEyebrow: 'Step one: profile basics',
    introTitle: 'A few questions to shape your baseline profile',
    introBody:
      'This is a baseline profile, not an event application. We use it to understand your style, your preferences, and what feels comfortable for you.',
    identityTitle: 'Basic details',
    identityBody: 'These details help us identify you, contact you, and keep your profile current.',
    fitTitle: 'Style and preferences',
    fitBody: 'This is where we learn how you like to meet new people and what settings feel most natural.',
    comfortTitle: 'A bit more context',
    comfortBody: 'A few extra lines help us make your profile feel more complete and human.',
    whyWeAskSocial: 'This link is not shown publicly. The team uses it only to confirm your identity.',
    whyWeAskOrigin: 'Knowing a little about where you are from helps us understand your background and context.',
    whyWeAskAboutYou: '2–5 lines are enough. Just help us get a better sense of you.',
    section: 'Section',
    back: 'Back',
    next: 'Continue',
    ...
    labels: {
      ...
      current_place: 'Where do you live now?',
      origin_place: 'Where are you from originally?',
      language_pref: 'What language setup feels most comfortable?',
      q22_interests: 'What kinds of things are you into?',
      q13_social_style: 'In new social settings, what feels most like you?',
      q17_recharge: 'After a busy period, how do you usually recharge?',
      q20_meeting_priority: 'What matters most when you meet new people?',
      q_match_preference: 'What mix feels best for you?',
      q25_motivation: 'What are you looking for socially, in general?',
      q26_about_you: 'Tell us a little about yourself',
      q27_comfort_needs: 'Is there anything that helps you feel comfortable?',
    },
  },
} as const;
