...
export const routeManifest: RouteManifestEntry[] = [
  {
    ...
    nextSteps: ['/events', '/questionnaire', '/terms', '/privacy'],
  },
  {
    path: '/privacy',
    workstream: 'participant',
  ...
  },
  {
    ...
    dataStatus: 'real',
    classification: 'Existing but expand',
    supportedStates: ['loading', 'empty', 'error', 'gated', 'success'],
    nextSteps: ['/dashboard', '/events'],
  },
  {
    ...
    nextSteps: ['/dashboard', '/questionnaire', '/gathering/:eventId'],
  },
  {
    path: '/questionnaire',
    workstream: 'participant',
  ...
  },
  {
    ...
    dataStatus: 'real',
    classification: 'Existing but normalize',
    supportedStates: ['loading', 'error', 'not_found', 'gated', 'success'],
    nextSteps: ['/events/:eventId/apply', '/events/:eventId', '/dashboard'],
  },
  {
    path: '/host/events',
    workstream: 'host',
